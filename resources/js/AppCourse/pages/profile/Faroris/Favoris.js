            ...
            <div className="flex flex-col md:flex-row items-stretch justify-start mt-6">
                <div className="w-full md:w-1/3 mb-4 border-b">
                    <Link to="/profile/favoris/cours">
                        <div className="flex items-center justify-center">
                            <img className="w-16 h-16 rounded-full object-cover" src="/assets/img/favoris_course.png" alt="image sur les cours" />
                        </div>
                ...
                <div className="w-full md:w-1/3 mb-4 border-b">
                    <Link to="/profile/favoris/exercices-solutions">
                        <div className="flex items-center justify-center">
                            <img className="w-16 h-16 rounded-full object-cover" src="/assets/img/exercices.png" alt="images sur exercices et solution" />
                        </div>
                ...
                {/* <div className="w-full md:w-1/3 mb-4 border-b">
                    <Link to="/profile/favoris/formations">
                        <div className="flex items-center justify-center">
                            <img className="w-16 h-16 rounded-full object-cover" src="/assets/img/formation.png" alt="image sur les formations" />
                        </div>
