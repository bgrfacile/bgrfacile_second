...
export default function ViewCours() {
    ...
    return (<div className='flex gap-3.5'>
        <div className='w-1/3 border bg-white rounded-2xl p-4'>
            ...
            <div className='flex items-center justify-between'>
                <div className="flex items-center gap-3.5">
                    ...
                    <div className="flex flex-col">
                        <span className="mb-1 capitalize">sofia müller</span>
            ...
            <div className="whitespace-pre-wrap mt-6">
                <h3 className='text-xl font-bold'>Hello guys 🥰</h3>
                <p className='text-base text-slate-600'>Salut les ges voici le resumer</p>
            </div>
