...
export default function CoursRoute() {
    ...
    return (<>
        ...
        <div className="h-full w-full md:w-fit px-4 fixed ml-0 md:ml-80 overflow-y-auto"> {/* w-11/12 sm:w-fit md:w-8/12 lg:w-8/12 xl:w-9/12 */}
