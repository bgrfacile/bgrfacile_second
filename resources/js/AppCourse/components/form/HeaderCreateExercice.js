        ...
        <div className="w-full grid grid-cols-4 bg-white border rounded-md mb-2">
            <div className="col-span-3 grid grid-rows-1 gap-2 p-3">
                <TextField
                    ...
                    label="titre de l'exercice" variant="outlined"
                    fullWidth />

                <div className='h-full'>
                    <FormGroup row>
                        <FormControlLabel control={<Checkbox onChange={(e) => { getIsSubjectExam(e.target.checked); }} checked={isSubjectExam} />} label="c'est un sujet d'examen" />
