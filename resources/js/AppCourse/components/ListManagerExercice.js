...
import { handleChargeIsSubject } from '../redux/features/Exercices/ExerciceSlice';
    ...
    return (<>
        <div className={`w-full rounded-sm bg-white h-full sticky p-2 md:pr-7 overflow-x-hidden ease-in-out duration-300 z-20`}>
            <div className="flex justify-between items-center pb-2 mb-2 border-b-2">
                <h4 className="text-2xl font-semibold">Explorateur Exercices</h4>
            ...
            <div className="flex flex-col overflow-x-auto">
                <div className="py-2 border-b border-gray-500">
                    <FormGroup>
                        <FormControlLabel
                            onChange={(e) => {
                                dispatch(handleChargeIsSubject({ isChecked: e.target.checked }));
                            }}
                            control={<Checkbox />} label="Que des sujets d'examen" />
                    </FormGroup>
                </div>
