...
import HiddenByRoleUser from './hiddenByRoleUser';
import ShowByRoleUser from './showByRoleUser';
...
export default function AsideProfile({ onClose }) {
    ...
    return (<>
        ...
        <div className="bg-white p-3 border-t-4 border-blue-600">
            ...
            <ShowByRoleUser rolesUser={user.roles} acceptRole={['super-admin', 'admin', 'professeur', 'professeur-has-ecole']}>
                <div>
            ...
            <div>
                <HiddenByRoleUser rolesUser={user.roles} acceptRole={['super-admin', 'admin', 'professeur', 'professeur-has-ecole']}>
                ...
                <HiddenByRoleUser rolesUser={user.roles} acceptRole={['super-admin', 'admin', 'promoteur', 'promoteur-middle-level', 'promoteur-high-level']}>
            ...
            <ShowByRoleUser rolesUser={user.roles} acceptRole={['super-admin', 'admin']}>
                <div>
