    ...
    return (
        <div className="flex flex-col items-center justify-center">
            ...
            <div className="flex justify-center mt-4">
                <Button className="w-32 mr-2">Annuler</Button>
                <Button className="w-32">Supprimer</Button>
            </div>
        </div>
    )
}
...
const Ligne = ({ user }) => (<tr className="border-b border-gray-200 hover:bg-gray-100">
    ...
    <td className="py-3 px-6 text-center">
        <div className="flex item-center justify-center">
            ...
            <button onClick={() => { alert('vous allez supprimé') }} className="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
