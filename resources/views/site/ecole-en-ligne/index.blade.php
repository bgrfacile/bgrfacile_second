            ...
            <div class="flex flex-wrap items-center">
                ...
                <div class="w-full md:w-6/12 px-4">
                    ...
                    <p class="mb-4 text-blueGray-500">
                        Un établissement scolaires enregistrés sur le site accède automatiquement au outils mise en
                        place par le site pour les écoles.
                    </p>
                    <div class="flex flex-wrap">
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Page public</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        une page public personnelle et personnalisable.(un miroir vers votre
                                        établissement)
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <p class="mb-4 text-blueGray-500">
                                        un espace administration de ses élèves directement en ligne.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">génération d'emploie du temps</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        un logiciel de reation et génération d'emploie du temps
                                    </p>
                                </div>
                            </div>
                            <div class="relative flex flex-col min-w-0">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">gestion de l'établissement</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        un logiciel de gestion complète de son établissement.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="w-full md:w-6/12 px-4">
                            <div class="relative flex flex-col min-w-0 mt-4">
                                <div class="px-4 py-5 flex-auto">
                                    ...
                                    <h6 class="text-xl mb-1 font-semibold">Devenir partenaire du site</h6>
                                    <p class="mb-4 text-blueGray-500">
                                        soutenir l'initiative bgrfacile
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="relative flex pb-5 space-x-5 border-b border-gray-200 lg:space-x-3 xl:space-x-5">
                        <svg class="w-16 h-16 text-green-400 rounded-2xl" viewBox="0 0 150 150"
                            ...
                            <g fill="none" fill-rule="evenodd">
                                ...
                                <path fill-opacity=".3" fill="#FFF" mask="url(#plan1)" d="M-33 83H67v100H-33z"></path>
                            </g>
                        </svg>
        ...
        <div class=" lg:py-12 lg:flex lg:justify-center">
            <div class="bg-white lg:mx-8 lg:flex lg:max-w-5xl lg:shadow-lg lg:rounded-lg">
                ...
                <div class="py-12 px-6 max-w-xl lg:max-w-5xl lg:w-1/2">
                    <h2 class="text-3xl text-gray-800 font-bold">recherchez une <span class="text-indigo-600">école en
                            ligne</span></h2>
