            ...
            <div class="xl:flex xl:items-center xL:-mx-4">
                ...
                <div class="grid justify-end grid-cols-1 gap-8 mt-8 xl:mt-0 xl:mx-4 xl:w-1/2 md:grid-cols-2">
                    <div>
                        ...
                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">CEO & Full stack developer</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Développeur full stack</p>
                    </div>
                </div>
            </div>
        </div>
