<x-site-layout>
    ...
    <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12 dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto">
            <div class="xl:flex xl:items-center xL:-mx-4">
                <div class="xl:w-1/2 xl:mx-4">
                    <h1 class="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Notre équipe
                    </h1>

                    <p class="max-w-2xl mt-4 text-gray-500 dark:text-gray-300">
                        Bgrfacile est une entreprise composée d'une équipe de jeunes développeurs passionnés, ainsi
                        nous souhaitons vous faire découvrir notre projet.<br>
                    </p>
                </div>
                ...
                <div class="grid justify-end grid-cols-1 gap-8 mt-8 xl:mt-0 xl:mx-4 xl:w-1/2 md:grid-cols-2">
                    <div>
                        ...
                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">CEO & Concepteur du site</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-gray-500 capitalize dark:text-gray-300">Co fondateur du site</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- <section class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        <div class="w-full text-center pb-8">
            <svg class="mx-auto" width="48" height="42" viewBox="0 0 48 42" fill="none"
            ...
            <p class="text-gray-400 font-normal text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
        ...
        <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white rounded-lg p-6">
                ...
                <div>
                    <p class="text-gray-400 leading-loose font-normal text-base">Lorem ipsum dolor sit amet, consectetur
