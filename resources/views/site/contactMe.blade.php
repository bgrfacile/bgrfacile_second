        ...
        <div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12">
                ...
                <form action="{{ route('contact.page.post') }}" method="POST">
                    ...
                    <div class="md:flex items-center mt-12">
                        <div class="w-full {{-- md:w-1/2 --}} flex flex-col">
                            ...
                            <input id="name" type="text" name="name" value="{{ old('name') }}" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200" />
                            @error('name')
            ...
            <div class="md:flex items-center mt-8">
                <div class="w-full flex flex-col">
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" class="leading-none text-gray-900 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200" />
                    @error('email')
                    <div class="text-red-600 text-sm mt-2">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div>
                <div class="w-full flex flex-col mt-8">
                    ...
                    <textarea id="message" type="text" name="message" class="h-40 text-base leading-none text-gray-900 p-3 focus:oultine-none focus:border-blue-700 mt-4 bg-gray-100 border rounded border-gray-200">{{ old('message') }}</textarea>
                    @error('message')
                    <div class="text-red-600 text-sm mt-2">{{ $message }}</div>
                    @enderror
                </div>
