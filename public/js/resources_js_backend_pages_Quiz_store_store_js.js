"use strict";
(globalThis["webpackChunk"] = globalThis["webpackChunk"] || []).push([["resources_js_backend_pages_Quiz_store_store_js"],{
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "changeCheckResponse": () => (/* binding */ changeCheckResponse),
/* harmony export */   "removeResponse": () => (/* binding */ removeResponse),
/* harmony export */   "changeTitleQuestionItem": () => (/* binding */ changeTitleQuestionItem),
/* harmony export */   "addResponse": () => (/* binding */ addResponse),
/* harmony export */   "removeQuestion": () => (/* binding */ removeQuestion),
/* harmony export */   "changeTitleQuizItem": () => (/* binding */ changeTitleQuizItem),
/* harmony export */   "changeTitleQuiz": () => (/* binding */ changeTitleQuiz),
...
var quizSlices = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_0__.createSlice)({
  name: "qui",
  initialState: {
    title: '',
    questions: []
  ...
  reducers: {
    changeTitleQuiz: function changeTitleQuiz(state, action) {
      state.title = action.payload;
    },
    addQuestion: function addQuestion(state, action) {
      state.questions = [{
        id: (0,uuid__WEBPACK_IMPORTED_MODULE_1__["default"])(),
        title: '',
        responses: []
      }].concat(_toConsumableArray(state.questions));
    },
    changeTitleQuizItem: function changeTitleQuizItem(state, action) {
      state.questions.find(function (el) {
        return el.id === action.payload.questionId;
      }).title = action.payload.value;
    },
    removeQuestion: function removeQuestion(state, action) {
      state.questions = state.questions.filter(function (el) {
        return el.id !== action.payload.questionId;
      });
    },
    addResponse: function addResponse(state, action) {
      state.questions.find(function (el) {
        return el.id === action.payload.questionId;
      }).responses = [{
        id: (0,uuid__WEBPACK_IMPORTED_MODULE_1__["default"])(),
        title: '',
        isCorrect: false
      }].concat(_toConsumableArray(state.questions.find(function (el) {
        return el.id === action.payload.questionId;
      }).responses));
    },
    changeTitleQuestionItem: function changeTitleQuestionItem(state, action) {
      state.questions.find(function (el) {
        return el.id === action.payload.questionId;
      }).responses.find(function (el) {
        return el.id === action.payload.responseId;
      }).title = action.payload.value;
    },
    removeResponse: function removeResponse(state, action) {
      state.questions.find(function (el) {
        return el.id === action.payload.questionId;
      }).responses = state.questions.find(function (el) {
        return el.id === action.payload.questionId;
      }).responses.filter(function (el) {
        return el.id !== action.payload.responseId;
      });
    },
    changeCheckResponse: function changeCheckResponse(state, action) {
      state.questions.find(function (el) {
        return el.id === action.payload.questionId;
      }).responses.find(function (el) {
        return el.id === action.payload.responseId;
...
var _quizSlices$actions = quizSlices.actions,
    changeCheckResponse = _quizSlices$actions.changeCheckResponse,
    removeResponse = _quizSlices$actions.removeResponse,
    changeTitleQuestionItem = _quizSlices$actions.changeTitleQuestionItem,
    addResponse = _quizSlices$actions.addResponse,
    removeQuestion = _quizSlices$actions.removeQuestion,
    changeTitleQuizItem = _quizSlices$actions.changeTitleQuizItem,
    changeTitleQuiz = _quizSlices$actions.changeTitleQuiz,
    addQuestion = _quizSlices$actions.addQuestion;

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (quizSlices.reducer);
...
/* harmony import */ var _quizSlices__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./quizSlices */ "./resources/js/backend/pages/Quiz/store/quizSlices.js");


var store = (0,_reduxjs_toolkit__WEBPACK_IMPORTED_MODULE_1__.configureStore)({
  reducer: {
    quiz: _quizSlices__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
});
